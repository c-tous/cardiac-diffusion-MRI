...
Please be aware that the sequences presented here, do not account for the gradients' limit of your MRI scanner. You will break the body coil if you use the full gradients' amplitude and a short TR. You will need to account for the cooling of your gradients. 
